...
- [FriendsOfShopware/shopware-chart](https://github.com/FriendsOfShopware/shopware-chart) - Helm chart based on shyim/shopware (2 days ago)
...
- [FriendsOfShopware/shopware-cli](https://github.com/FriendsOfShopware/shopware-cli) ([0.1.9](https://github.com/FriendsOfShopware/shopware-cli/releases/tag/0.1.9), 2 days ago) - CLI for Shopware Account
- [composer/composer](https://github.com/composer/composer) ([2.2.5](https://github.com/composer/composer/releases/tag/2.2.5), 6 days ago) - Dependency Manager for PHP
