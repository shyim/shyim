...
- [FriendsOfShopware/css-api](https://github.com/FriendsOfShopware/css-api) - CSS API using AWS Lambda (4 days ago)
...
- [coder/coder](https://github.com/coder/coder) ([v0.22.1](https://github.com/coder/coder/releases/tag/v0.22.1), 1 day ago) - A tool that provisions remote development environments via Terraform
- [Roave/BetterReflection](https://github.com/Roave/BetterReflection) ([6.9.0](https://github.com/Roave/BetterReflection/releases/tag/6.9.0), 1 day ago) - :crystal_ball: Better Reflection is a reflection API that aims to improve and provide more features than PHP&#39;s built-in reflection API.
- [vitejs/vite](https://github.com/vitejs/vite) ([v4.3.0-beta.6](https://github.com/vitejs/vite/releases/tag/v4.3.0-beta.6), 3 days ago) - Next generation frontend tooling. It&#39;s fast!
...
- [paratestphp/paratest](https://github.com/paratestphp/paratest) ([v7.1.3](https://github.com/paratestphp/paratest/releases/tag/v7.1.3), 3 days ago) - :computer: Parallel testing for PHPUnit
- [shopware/e2e-testsuite-platform](https://github.com/shopware/e2e-testsuite-platform) ([7.0.5](https://github.com/shopware/e2e-testsuite-platform/releases/tag/7.0.5), 5 days ago) - This package contains the e2e platform test suite for Shopware 6 using Cypress
