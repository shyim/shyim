...
- [phpstan/phpstan-symfony](https://github.com/phpstan/phpstan-symfony) ([0.12.40](https://github.com/phpstan/phpstan-symfony/releases/tag/0.12.40), 2 days ago) - Symfony extension for PHPStan
- [FriendsOfShopware/FroshPlatformThumbnailProcessor](https://github.com/FriendsOfShopware/FroshPlatformThumbnailProcessor) ([1.0.18](https://github.com/FriendsOfShopware/FroshPlatformThumbnailProcessor/releases/tag/1.0.18), 4 days ago) - This shopware6 plugin allows you to use variable thumbnails - on the fly. Including lazy loading.
