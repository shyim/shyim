...
- [FriendsOfShopware/shopware-cli](https://github.com/FriendsOfShopware/shopware-cli) ([0.1.78](https://github.com/FriendsOfShopware/shopware-cli/releases/tag/0.1.78), 1 day ago) - CLI for Shopware Account and Shopware 6
- [FriendsOfShopware/FroshPlatformThumbnailProcessor](https://github.com/FriendsOfShopware/FroshPlatformThumbnailProcessor) ([3.0.1](https://github.com/FriendsOfShopware/FroshPlatformThumbnailProcessor/releases/tag/3.0.1), 3 days ago) - This shopware6 plugin allows you to use variable thumbnails - on the fly. Including lazy loading.
- [shopware/web-installer](https://github.com/shopware/web-installer) ([0.0.11](https://github.com/shopware/web-installer/releases/tag/0.0.11), 3 days ago) - The new updater for Shopware
- [FriendsOfShopware/FroshTools](https://github.com/FriendsOfShopware/FroshTools) ([1.0.6](https://github.com/FriendsOfShopware/FroshTools/releases/tag/1.0.6), 3 days ago) - A collection of useful tools for Shopware 6
- [shopware/platform](https://github.com/shopware/platform) ([v6.5.1.1](https://github.com/shopware/platform/releases/tag/v6.5.1.1), 5 days ago) - Shopware 6 is an open commerce platform based on Symfony Framework and Vue and supported by a worldwide community and more than 1.500 community extensions
