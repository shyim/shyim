...
- [Mic92/ssh-to-age](https://github.com/Mic92/ssh-to-age) ([1.1.11](https://github.com/Mic92/ssh-to-age/releases/tag/1.1.11), 1 day ago) - Convert SSH Ed25519 keys to age keys. This is useful for usage in sops-nix and sops
- [shyim/jetbrains-github-copilot-patcher](https://github.com/shyim/jetbrains-github-copilot-patcher) ([1.5.39.9605-243-nightly](https://github.com/shyim/jetbrains-github-copilot-patcher/releases/tag/1.5.39.9605-243-nightly), 2 days ago) - Patcher for Github Copilot to work with Jetbrain IDE EAP versions
...
- [shyim/danger-php](https://github.com/shyim/danger-php) ([0.3.10](https://github.com/shyim/danger-php/releases/tag/0.3.10), 6 days ago) - Danger runs during your CI process, and gives teams the chance to automate common code review chores.
