...
- [FriendsOfShopware/FroshTools](https://github.com/FriendsOfShopware/FroshTools) ([3.5.0](https://github.com/FriendsOfShopware/FroshTools/releases/tag/3.5.0), 3 days ago) - A collection of useful tools for Shopware 6
- [opensearch-project/opensearch-php](https://github.com/opensearch-project/opensearch-php) ([2.6.0](https://github.com/opensearch-project/opensearch-php/releases/tag/2.6.0), 4 days ago) - Official PHP Client for OpenSearch
- [cachix/devenv](https://github.com/cachix/devenv) ([v2.0.6](https://github.com/cachix/devenv/releases/tag/v2.0.6), 6 days ago) - Fast, Declarative, Reproducible, and Composable Developer Environments using Nix
