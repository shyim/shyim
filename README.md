...
- [rojopolis/spellcheck-github-actions](https://github.com/rojopolis/spellcheck-github-actions) ([0.55.0](https://github.com/rojopolis/spellcheck-github-actions/releases/tag/0.55.0), 2 days ago) - Spell check action
- [cachix/devenv](https://github.com/cachix/devenv) ([v1.11.2](https://github.com/cachix/devenv/releases/tag/v1.11.2), 2 days ago) - Fast, Declarative, Reproducible, and Composable Developer Environments using Nix
...
- [shivammathur/setup-php](https://github.com/shivammathur/setup-php) ([2.36.0](https://github.com/shivammathur/setup-php/releases/tag/2.36.0), 3 days ago) - GitHub action to set up PHP with extensions, php.ini configuration, coverage drivers, and various tools.
