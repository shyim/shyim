...
- [symfony-cli/symfony-cli](https://github.com/symfony-cli/symfony-cli) ([v5.5.0](https://github.com/symfony-cli/symfony-cli/releases/tag/v5.5.0), 2 days ago) - The Symfony CLI tool
- [coder/coder](https://github.com/coder/coder) ([v0.17.3](https://github.com/coder/coder/releases/tag/v0.17.3), 3 days ago) - A tool that provisions remote development environments via Terraform
- [symfony/demo](https://github.com/symfony/demo) ([v2.2.2](https://github.com/symfony/demo/releases/tag/v2.2.2), 3 days ago) - Symfony Demo Application
- [paratestphp/paratest](https://github.com/paratestphp/paratest) ([v7.0.6](https://github.com/paratestphp/paratest/releases/tag/v7.0.6), 4 days ago) - :computer: Parallel testing for PHPUnit
