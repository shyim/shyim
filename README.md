...
- [shyim/FroshAbandonedCart](https://github.com/shyim/FroshAbandonedCart) - Shopware 6 plugin to capture abandoned carts, restore them on login, and automate recovery emails with voucher codes (2 days ago)
- [FriendsOfShopware/shopware-demo-environment](https://github.com/FriendsOfShopware/shopware-demo-environment) -  (3 days ago)
- [shyim/cloudflare-tui](https://github.com/shyim/cloudflare-tui) - Terminal UI for Cloudflare DNS (6 days ago)
...
- [openpubkey/opkssh](https://github.com/openpubkey/opkssh) ([v0.13.0](https://github.com/openpubkey/opkssh/releases/tag/v0.13.0), 1 day ago) - opkssh (OpenPubkey SSH)
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.3.0](https://github.com/carthage-software/mago/releases/tag/1.3.0), 5 days ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
- [composer/composer](https://github.com/composer/composer) ([2.9.5](https://github.com/composer/composer/releases/tag/2.9.5), 5 days ago) - Dependency Manager for PHP
- [symfony/symfony](https://github.com/symfony/symfony) ([v8.0.5](https://github.com/symfony/symfony/releases/tag/v8.0.5), 6 days ago) - The Symfony PHP framework
