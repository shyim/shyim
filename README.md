...
- [FriendsOfShopware/css-api](https://github.com/FriendsOfShopware/css-api) - CSS API using AWS Lambda (2 days ago)
...
- [vitejs/vite](https://github.com/vitejs/vite) ([v4.3.0-beta.6](https://github.com/vitejs/vite/releases/tag/v4.3.0-beta.6), 1 day ago) - Next generation frontend tooling. It&#39;s fast!
- [FriendsOfShopware/FroshTools](https://github.com/FriendsOfShopware/FroshTools) ([0.2.16](https://github.com/FriendsOfShopware/FroshTools/releases/tag/0.2.16), 1 day ago) - A collection of useful tools for Shopware 6
- [paratestphp/paratest](https://github.com/paratestphp/paratest) ([v7.1.3](https://github.com/paratestphp/paratest/releases/tag/v7.1.3), 1 day ago) - :computer: Parallel testing for PHPUnit
- [shopware/e2e-testsuite-platform](https://github.com/shopware/e2e-testsuite-platform) ([7.0.5](https://github.com/shopware/e2e-testsuite-platform/releases/tag/7.0.5), 3 days ago) - This package contains the e2e platform test suite for Shopware 6 using Cypress
