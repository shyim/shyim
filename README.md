...
- [roadrunner-server/roadrunner](https://github.com/roadrunner-server/roadrunner) ([v2024.1.2](https://github.com/roadrunner-server/roadrunner/releases/tag/v2024.1.2), 1 day ago) - 🤯 High-performance PHP application server, process manager written in Go and powered with plugins
- [shyim/testcontainer](https://github.com/shyim/testcontainer) ([0.1.2](https://github.com/shyim/testcontainer/releases/tag/0.1.2), 1 day ago) - https://www.testcontainers.org implementation for PHP
- [shopware/app-php-sdk](https://github.com/shopware/app-php-sdk) ([2.0.4](https://github.com/shopware/app-php-sdk/releases/tag/2.0.4), 3 days ago) - Shopware APP SDK Independent of Frameworks
- [dunglas/frankenphp](https://github.com/dunglas/frankenphp) ([v1.1.5](https://github.com/dunglas/frankenphp/releases/tag/v1.1.5), 3 days ago) - 🧟 The modern PHP app server
...
- [shopware/conflicts](https://github.com/shopware/conflicts) ([0.1.21](https://github.com/shopware/conflicts/releases/tag/0.1.21), 4 days ago) - Shopware 6 conflicting packages
