...
- [FriendsOfShopware/FroshTools](https://github.com/FriendsOfShopware/FroshTools) ([3.5.0](https://github.com/FriendsOfShopware/FroshTools/releases/tag/3.5.0), 4 days ago) - A collection of useful tools for Shopware 6
- [opensearch-project/opensearch-php](https://github.com/opensearch-project/opensearch-php) ([2.6.0](https://github.com/opensearch-project/opensearch-php/releases/tag/2.6.0), 5 days ago) - Official PHP Client for OpenSearch
