...
- [cachix/devenv](https://github.com/cachix/devenv) ([v2.1](https://github.com/cachix/devenv/releases/tag/v2.1), 1 day ago) - Fast, Declarative, Reproducible, and Composable Developer Environments using Nix
- [shyim/docker-backup](https://github.com/shyim/docker-backup) ([0.2.0](https://github.com/shyim/docker-backup/releases/tag/0.2.0), 2 days ago) - A powerful, label-driven backup daemon for Docker containers with scheduled backups, multiple storage backends, and a beautiful web dashboard.
