...
- [composer/composer](https://github.com/composer/composer) ([2.2.3](https://github.com/composer/composer/releases/tag/2.2.3), 1 day ago) - Dependency Manager for PHP
- [JetBrains/qodana-action](https://github.com/JetBrains/qodana-action) ([v4.2.1](https://github.com/JetBrains/qodana-action/releases/tag/v4.2.1), 2 days ago) - ⚙️ Using this GitHub Action, run Qodana with your GitHub workflow to scan your Java, Kotlin, PHP, Python, JavaScript, TypeScript projects
