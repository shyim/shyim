...
- [shyim/jetbrains-github-copilot-patcher](https://github.com/shyim/jetbrains-github-copilot-patcher) ([1.5.44.10254-241-nightly](https://github.com/shyim/jetbrains-github-copilot-patcher/releases/tag/1.5.44.10254-241-nightly), 1 day ago) - Patcher for Github Copilot to work with Jetbrain IDE EAP versions
- [elastic/elastic-transport-php](https://github.com/elastic/elastic-transport-php) ([v9.0.1](https://github.com/elastic/elastic-transport-php/releases/tag/v9.0.1), 2 days ago) - 
- [cachix/devenv](https://github.com/cachix/devenv) ([v1.6.1](https://github.com/cachix/devenv/releases/tag/v1.6.1), 2 days ago) - Fast, Declarative, Reproducible, and Composable Developer Environments using Nix
- [testcontainers/testcontainers-php](https://github.com/testcontainers/testcontainers-php) ([1.0.2](https://github.com/testcontainers/testcontainers-php/releases/tag/1.0.2), 2 days ago) - https://www.testcontainers.org implementation for PHP
- [shyim/1password-load-secrets-action](https://github.com/shyim/1password-load-secrets-action) ([v1.0.1](https://github.com/shyim/1password-load-secrets-action/releases/tag/v1.0.1), 4 days ago) - 
