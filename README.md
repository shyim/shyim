...
- [shyim/jetbrains-github-copilot-patcher](https://github.com/shyim/jetbrains-github-copilot-patcher) ([1.5.50.11684-241-nightly](https://github.com/shyim/jetbrains-github-copilot-patcher/releases/tag/1.5.50.11684-241-nightly), 3 days ago) - Patcher for Github Copilot to work with Jetbrain IDE EAP versions
- [muety/wakapi](https://github.com/muety/wakapi) ([2.14.1](https://github.com/muety/wakapi/releases/tag/2.14.1), 4 days ago) - 📊 A minimalist, self-hosted WakaTime-compatible backend for coding statistics
- [cachix/devenv](https://github.com/cachix/devenv) ([v1.8](https://github.com/cachix/devenv/releases/tag/v1.8), 4 days ago) - Fast, Declarative, Reproducible, and Composable Developer Environments using Nix
- [openpubkey/opkssh](https://github.com/openpubkey/opkssh) ([v0.8.0](https://github.com/openpubkey/opkssh/releases/tag/v0.8.0), 5 days ago) - opkssh (OpenPubkey SSH)
