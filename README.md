...
- [coder/coder](https://github.com/coder/coder) ([v0.15.3](https://github.com/coder/coder/releases/tag/v0.15.3), today) - A tool that provisions remote development environments via Terraform
- [FriendsOfShopware/shopware-cli](https://github.com/FriendsOfShopware/shopware-cli) ([0.1.50](https://github.com/FriendsOfShopware/shopware-cli/releases/tag/0.1.50), 1 day ago) - CLI for Shopware Account
- [vitejs/vite](https://github.com/vitejs/vite) ([create-vite@4.1.0-beta.0](https://github.com/vitejs/vite/releases/tag/create-vite%404.1.0-beta.0), 1 day ago) - Next generation frontend tooling. It&#39;s fast!
- [shopwareLabs/shopware6-phpstorm-plugin](https://github.com/shopwareLabs/shopware6-phpstorm-plugin) ([0.0.34](https://github.com/shopwareLabs/shopware6-phpstorm-plugin/releases/tag/0.0.34), 2 days ago) - 
