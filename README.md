...
- [doctrine/dbal](https://github.com/doctrine/dbal) ([3.8.7](https://github.com/doctrine/dbal/releases/tag/3.8.7), 6 days ago) - Doctrine Database Abstraction Layer
- [shyim/danger-php](https://github.com/shyim/danger-php) ([0.3.4](https://github.com/shyim/danger-php/releases/tag/0.3.4), 6 days ago) - Danger runs during your CI process, and gives teams the chance to automate common code review chores.
- [digilist/dependency-graph](https://github.com/digilist/dependency-graph) ([v0.4.2](https://github.com/digilist/dependency-graph/releases/tag/v0.4.2), 6 days ago) - Dependency Graph Resolver in PHP
