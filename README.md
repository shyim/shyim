...
- [shyim/go-version](https://github.com/shyim/go-version) - Zero-dependency Go library that ports PHP Composer&#39;s version parsing and constraint semantics — caret (^), tilde (~), wildcards, hyphen ranges, stability flags, prerelease comparison, and constraint intersection for dependency solvers. (2 days ago)
...
- [shyim/go-spdx](https://github.com/shyim/go-spdx) - Go library for validating SPDX license expressions. Zero dependencies, pure Go standard library. (2 days ago)
- [FriendsOfShopware/shopmon-cli](https://github.com/FriendsOfShopware/shopmon-cli) - CLI for Shopmon as a Companion (3 days ago)
- [hetzneronline/community-content](https://github.com/hetzneronline/community-content) - Hetzner Online Community Project (3 days ago)

---

#### 🔭 Latest releases I've contributed to

- [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) ([v2026.6.3-canary.1038](https://github.com/toeverything/AFFiNE/releases/tag/v2026.6.3-canary.1038), 1 day ago) - There can be more than Notion and Miro. AFFiNE(pronounced [ə‘fain]) is a next-gen knowledge base that brings planning, sorting and creating all together. Privacy first, open-source, customizable and ready to use. 
...
- [composer/composer](https://github.com/composer/composer) ([2.10.0](https://github.com/composer/composer/releases/tag/2.10.0), 1 week ago) - Dependency Manager for PHP
