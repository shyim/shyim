...
- [composer/composer](https://github.com/composer/composer) ([2.9.3](https://github.com/composer/composer/releases/tag/2.9.3), 1 day ago) - Dependency Manager for PHP
- [muety/wakapi](https://github.com/muety/wakapi) ([2.17.0](https://github.com/muety/wakapi/releases/tag/2.17.0), 2 days ago) - 📊 A minimalist, self-hosted WakaTime-compatible backend for coding statistics
- [rojopolis/spellcheck-github-actions](https://github.com/rojopolis/spellcheck-github-actions) ([0.56.0](https://github.com/rojopolis/spellcheck-github-actions/releases/tag/0.56.0), 4 days ago) - Spell check action
- [testcontainers/testcontainers-php](https://github.com/testcontainers/testcontainers-php) ([1.0.4](https://github.com/testcontainers/testcontainers-php/releases/tag/1.0.4), 4 days ago) - https://www.testcontainers.org implementation for PHP
