...
- [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) ([v2026.2.18-canary.916](https://github.com/toeverything/AFFiNE/releases/tag/v2026.2.18-canary.916), 1 day ago) - There can be more than Notion and Miro. AFFiNE(pronounced [ə‘fain]) is a next-gen knowledge base that brings planning, sorting and creating all together. Privacy first, open-source, customizable and ready to use. 
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.9.1](https://github.com/carthage-software/mago/releases/tag/1.9.1), 1 day ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
- [FriendsOfShopware/shopmon-cli](https://github.com/FriendsOfShopware/shopmon-cli) ([0.0.1](https://github.com/FriendsOfShopware/shopmon-cli/releases/tag/0.0.1), 4 days ago) - CLI for Shopmon as a Companion
