...
- [shyim/FroshAbandonedCart](https://github.com/shyim/FroshAbandonedCart) - Shopware 6 plugin to capture abandoned carts, restore them on login, and automate recovery emails with voucher codes (1 day ago)
...
- [shyim/cloudflare-tui](https://github.com/shyim/cloudflare-tui) - Terminal UI for Cloudflare DNS (5 days ago)
...
- [carthage-software/mago](https://github.com/carthage-software/mago) ([1.3.0](https://github.com/carthage-software/mago/releases/tag/1.3.0), 4 days ago) - Mago is a toolchain for PHP that aims to provide a set of tools to help developers write better code.
- [composer/composer](https://github.com/composer/composer) ([2.9.5](https://github.com/composer/composer/releases/tag/2.9.5), 4 days ago) - Dependency Manager for PHP
...
- [squirrelphp/twig-php-syntax](https://github.com/squirrelphp/twig-php-syntax) ([v2.0](https://github.com/squirrelphp/twig-php-syntax/releases/tag/v2.0), 6 days ago) - Adds common PHP syntax to twig templates, like ===, foreach and strtotime
...
- [rojopolis/spellcheck-github-actions](https://github.com/rojopolis/spellcheck-github-actions) ([0.58.0](https://github.com/rojopolis/spellcheck-github-actions/releases/tag/0.58.0), 1 week ago) - Spell check action
- [openpubkey/opkssh](https://github.com/openpubkey/opkssh) ([v0.12.0](https://github.com/openpubkey/opkssh/releases/tag/v0.12.0), 2 weeks ago) - opkssh (OpenPubkey SSH)
