...
- [shopware/web-recovery](https://github.com/shopware/web-recovery) - The new updater for Shopware (1 day ago)
...
- [coder/coder](https://github.com/coder/coder) ([v0.14.0](https://github.com/coder/coder/releases/tag/v0.14.0), 1 day ago) - A tool that provisions remote development environments via Terraform
- [vitejs/vite](https://github.com/vitejs/vite) ([v4.1.0-beta.0](https://github.com/vitejs/vite/releases/tag/v4.1.0-beta.0), 1 day ago) - Next generation frontend tooling. It&#39;s fast!
- [FriendsOfShopware/shopware-cli](https://github.com/FriendsOfShopware/shopware-cli) ([0.1.47](https://github.com/FriendsOfShopware/shopware-cli/releases/tag/0.1.47), 1 day ago) - CLI for Shopware Account
- [shopware/web-recovery](https://github.com/shopware/web-recovery) ([0.0.1](https://github.com/shopware/web-recovery/releases/tag/0.0.1), 6 days ago) - The new updater for Shopware
